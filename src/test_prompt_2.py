...
def reformulate_information(data):
    ...
    6. Important: DO NOT ADD additional information if is not provided in the data. Avoid adding information that was not given, better to mention that "There is no more relevant info".
